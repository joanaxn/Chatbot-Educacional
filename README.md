...
O objetivo é permitir que os estudantes realizem perguntas ao chatbot e que obtenham respostas baseadas **exclusivamente nos materiais fornecidos pelos docentes** para cada unidade curricular.
...
- Gestão de materiais pelos docentes (PDF, DOCX, PPTX);  
- Extração automática de texto;
- Geração de embeddings por cadeira;  
- Pesquisa semântica com ChromaDB;;  
- Respostas contextualizadas usando IA local; 
...
- **Backend FastAPI** trata dos pedidos, gera embeddings e comunica com o modelo; 
